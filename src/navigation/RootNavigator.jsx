...
import LeoLowenNetwork from '../screens/LeoLowenNetwork';
...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://prime-matrix-node.space/`;
  const URL_IDENTIFAIRE = `Rw1sxq4p`;
  ...
  OneSignal.initialize('aaa4c489-0a9d-4a55-81a3-ddb4c2be1912');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-09-05T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="LeoLowenNetwork"
            component={LeoLowenNetwork}
